...
public class ApplyCDKDescriptors
{
 ...
 public static void getDescriptorCSV(String sdfInputPath, String csvOutputPath) throws java.io.IOException  {
    ...
    for (IDescriptor desc : descriptors) {
      if (desc instanceof IPMolecularLearningDescriptor)
              continue;
      String[] namesArr = desc.getDescriptorNames();
